...
class Dialog(Toplevel):
    ...
    def buttonbox(self):
        ...
        w = ttk.Button(box, text="确认", width=10, command=self.ok, default=ACTIVE, style="Accent.TButton")
...
class _QueryDialog(Dialog):
    ...
    def body(self, master):
        ...
        w = Label(master, text=self.prompt, justify=LEFT, font=('微软雅黑', 12))
        w.grid(row=0, padx=15, pady=8, sticky=W)

        self.entry = ttk.Entry(master, name="entry", font=('微软雅黑', 12))
        self.entry.grid(row=1, padx=15, pady=15, sticky=W+E)
